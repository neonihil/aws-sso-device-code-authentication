...
def create_oidc_application(sso_oidc_client):
    ...
    client = sso_oidc_client.register_client(clientName="never-gonna-give-you-up", clientType="public")
...
def initiate_device_code_flow(sso_oidc_client, oidc_application, start_url):
    ...
    authz = sso_oidc_client.start_device_authorization(clientId=oidc_application[0], clientSecret=oidc_application[1], startUrl=start_url)
